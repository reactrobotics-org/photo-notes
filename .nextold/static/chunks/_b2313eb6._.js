...
"[project]/components/NewSubmissionForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewSubmissionForm(param) {
    let { userId: _userId } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewSubmissionForm.useEffect": ()=>{
            const check = {
                "NewSubmissionForm.useEffect.check": async ()=>{
                    const { data: { user } } = await supabase.auth.getUser();
                    if (!user) router.replace('/');
                }
            }["NewSubmissionForm.useEffect.check"];
            check();
    ...
    const previewUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewSubmissionForm.useMemo[previewUrl]": ()=>file ? URL.createObjectURL(file) : null
    }["NewSubmissionForm.useMemo[previewUrl]"], [
        file
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewSubmissionForm.useEffect": ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const key = "".concat(user.id, "/").concat(crypto.randomUUID(), ".").concat(ext);
            ...
            setError((err === null || err === void 0 ? void 0 : err.message) || 'Something went wrong.');
        } finally{
            setLoading(false);
        }
    };
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                onChange: (e)=>{
                                    ...
                                    return onFileChange((_e_target_files_ = (_e_target_files = e.target.files) === null || _e_target_files === void 0 ? void 0 : _e_target_files[0]) !== null && _e_target_files_ !== void 0 ? _e_target_files_ : null);
                                }
                            }, void 0, false, {
                                fileName: "[project]/components/NewSubmissionForm.tsx",
                                lineNumber: 127,
...
_s(NewSubmissionForm, "LtSvYITz/XcChKXfjShTFOb3W/E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = NewSubmissionForm;
/**
...
async function canvasTypeSupported(type) {
    ...
    return data.startsWith("data:".concat(type));
}
...
var _c;
__turbopack_context__.k.register(_c, "NewSubmissionForm");
...
//# sourceMappingURL=_b2313eb6._.js.map